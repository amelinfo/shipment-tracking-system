...
public class TrackingController {
    ...
    public ResponseEntity<Map<String, String>> getShipmentStatus(
        ...
        Optional<String> currentStatusOpt = trackingService.getCurrentStatus(trackingId);
    ...
    public ResponseEntity<List<Map<String, Object>>> getAllTrackedShipments() {
        var shipments = trackingService.getTrackedShipments().entrySet().stream()
        .map(entry -> Map.of(
            "trackingId", entry.getKey(),
